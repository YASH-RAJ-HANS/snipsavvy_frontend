      ...
      <div className="flex justify-around w-full">
        <div>
          <div
            ...
            className="max-w-sm p-6 bg-zinc-950 border border-gray-200 rounded-md shadow dark:bg-gray-800 dark:border-gray-700"
          >
            <svg
        ...
        <div>
          ...
          >
            ...
            <a
              href="#"
              className="inline-flex flex font-normal items-center text-blue-600 hover:underline"
            >
              See our guideline
              <svg
                className="w-3 h-3 ms-2.5 rtl:rotate-[270deg]"
