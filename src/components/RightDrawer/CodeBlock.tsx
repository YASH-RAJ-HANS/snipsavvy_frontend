...
function CodeBlock() {
  ...
  return (
    <div>
      {codeData && (
        <div>
          <h2 className="text-2xl text-white px-2 font-bold overflow-y-auto">
            {codeData[0]?.title}
          </h2>
          <h2 className="text-lg text-white px-2 font-semibold mb-2">
            ...
            <div className="relative">
              ...
              <div className="min-h-[50vh] min-w-[40vw] w-[47vw] fixed pt-1 rounded-b-md border-zinc-900 bg-zinc-900">
                <pre className="p-4">
                  <code
                    id="editable-code"
                    className={`language-javascript ${isEditable ? "text-black" : "text-white"}`}
